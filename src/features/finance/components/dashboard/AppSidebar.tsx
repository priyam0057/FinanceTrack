...
import CalculatorComponent from "@/features/finance/pages/Calculator";
import UnitConverterComponent from "@/features/finance/pages/UnitConverter";
import TipCalculatorComponent from "@/features/finance/pages/TipCalculator";
...
const mainItems = [
  { title: "Dashboard", url: "/finance", icon: Home },
  { title: "Transactions", url: "/finance/transactions", icon: TrendingUp },
  { title: "Budget Management", url: "/finance/budget-management", icon: Wallet },
